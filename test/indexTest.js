    ...
    describe("it adds a timeIn event Object to an employee's record of timeInEvents when provided an employee record and Date/Time String and returns the updated record", function () {
        ...
        describe("createTimeInEvent", function () {
            ...
            it("creates the correct type", function () {
                let bpRecord = createEmployeeRecord([
                    "Byron",
                    "Poodle",
                    "Mascot",
                    3,
    ...
    describe("Given an employee record with a date-matched timeInEvent and timeOutEvent", function () {
        ...
        describe("hoursWorkedOnDate", function () {
            it("calculates that the employee worked 2 hours", function () {
                ...
                expect(hoursWorkedOnDate.call(cRecord, "2044-03-15")).to.equal(
                    2
                );
            });
        });
    ...
    describe("Given an employee record with a date-matched timeInEvent and timeOutEvent", function () {
        ...
        describe("wagesEarnedOnDate", function () {
            it("calculates that the employee earned 54 dollars", function () {
                ...
                createTimeInEvent.call(cRecord, "2044-03-15 0900");
                createTimeOutEvent.call(cRecord, "2044-03-15 1100");
                expect(wagesEarnedOnDate.call(cRecord, "2044-03-15")).to.equal(
                    54
                );
            });
    ...
    describe("runs payroll using the mock data provided by Ultron data systems", function () {
        ...
        describe("Full Payroll Test", function () {
            ...
            const csvTimesIn = [
                [
                    "Thor",
                    ["2018-01-01 0800", "2018-01-02 0800", "2018-01-03 0800"],
                ],
                [
                    "Loki",
                    ["2018-01-01 0700", "2018-01-02 0700", "2018-01-03 0600"],
                ],
                [
                    "Natalia",
                    ["2018-01-03 1700", "2018-01-05 1800", "2018-01-03 1300"],
                ],
                [
                    "Darcey",
                    ["2018-01-01 0700", "2018-01-02 0800", "2018-01-03 0800"],
                ],
                [
                    "Jarvis",
                    ["2018-01-01 0500", "2018-01-02 0500", "2018-01-03 0500"],
                ],
                [
                    "Anthony",
                    ["2018-01-01 1400", "2018-01-02 1400", "2018-01-03 1400"],
                ],
            ];
            ...
            const csvTimesOut = [
                [
                    "Thor",
                    ["2018-01-01 1600", "2018-01-02 1800", "2018-01-03 1800"],
                ],
                [
                    "Loki",
                    ["2018-01-01 1700", "2018-01-02 1800", "2018-01-03 1800"],
                ],
                [
                    "Natalia",
                    ["2018-01-03 2300", "2018-01-05 2300", "2018-01-03 2300"],
                ],
                [
                    "Darcey",
                    ["2018-01-01 1300", "2018-01-02 1300", "2018-01-03 1300"],
                ],
                [
                    "Jarvis",
                    ["2018-01-01 1800", "2018-01-02 1800", "2018-01-03 1800"],
                ],
                [
                    "Anthony",
                    ["2018-01-01 1600", "2018-01-02 1600", "2018-01-03 1600"],
                ],
            ];
            ...
            describe("from several imported CSV structures", function () {
                ...
                describe("calculatePayroll", function () {
                    ...
                    it("correctly sums the payroll burden to $11,880 when passed an array of employee records", function () {
                        let employeeRecords =
                            createEmployeeRecords(csvDataEmployees);
                        employeeRecords.forEach(function (rec) {
                            let timesInRecordRow = csvTimesIn.find(function (
                                row
                            ) {
                                return rec.firstName === row[0];
                            });

                            let timesOutRecordRow = csvTimesOut.find(function (
                                row
                            ) {
                                return rec.firstName === row[0];
                            });
                            ...
                            timesOutRecordRow[1].forEach(function (
                                timeOutStamp
                            ) {
